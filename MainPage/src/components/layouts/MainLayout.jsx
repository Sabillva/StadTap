...
const MainLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0e100f]">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 transition-all duration-300 mx-4 mt-4">
            ...
            <div className="flex justify-between items-center h-14 px-4">
              ...
              >
                <button
                  ...
                  className="flex items-center text-white/50 hover:text-[#fffce1] transition-colors duration-200 rounded-full p-1"
                >
                ...
                {showProfileMenu && (
                  <div
                    className="absolute right-0 mt-2 w-56 bg-[#0e100f]/90 backdrop-blur-md border-2 border-white/15 rounded-2xl shadow-xl overflow-hidden"
                    style={{ zIndex: 9999 }}
                  >
                    <div className="py-1">
                      <Link
                  ...
                  <div className="py-4 px-4 flex flex-col space-y-4">
                    ...
                    >
                      <motion.button
                        ...
                        className="w-full py-2.5 px-6 rounded-full bg-gradient-to-br from-[#4de840] to-[#2ca322] text-[#0e100f] font-medium shadow-[4px_4px_8px_rgba(14,16,15,0.2),-1px_-1px_10px_rgba(255,255,255,0.2)]"
